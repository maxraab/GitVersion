    ...
    public class Szenario2
    {
        ...
        public void CommitsInMaster()
        {
            using (var fixture = new EmptyRepositoryFixture())
            {
                ...
                fixture.AssertFullSemver(_config, "0.10.1-pre.1+16");
            }
        }
        ...
        public void CommitsInFeatureBranchWithSingleFeatureBranch()
        {
            using (var fixture = new EmptyRepositoryFixture())
            {
                ...
                fixture.AssertFullSemver(_config, "0.10.1-BranchD.1+23");
            }
        }
        ...
        public void CommitsInFeatureBranchWithMultipleFeatureBranches()
        {
            using (var fixture = new EmptyRepositoryFixture())
            {
                ...
                fixture.AssertFullSemver(_config, "0.10.1-BranchE.1+23");
            }
        }
